...
- 대표적으로 [버블정렬](brain/notes/CS/Algo/sort/comparison/bubbleSort), [선택정렬](brain/notes/CS/Algo/sort/comparison/selectSort), [삽입정렬](brain/notes/CS/Algo/sort/comparison/insertSort), [합병정렬](brain/notes/CS/Algo/sort/comparison/mergeSort), [퀵정렬](brain/notes/CS/Algo/sort/comparison/quickSort), [힙 정렬](brain/notes/CS/Algo/sort/comparison/heapSort)
- 메모리를 어떻게 쓰냐에 따라 **내부 정렬**, **외부 정렬**, [제자리 정렬](brain/notes/CS/Algo/sort/etcsort/inplaceSort)로 나뉨
- 두 값이 같을 때, 값이 어떤 순서로 정렬되는지에 따라 [안정 정렬](brain/notes/CS/Algo/sort/etcsort/stableSort), [불안정 정렬](brain/notes/CS/Algo/sort/etcsort/unstableSort)로 나뉨
...
그렇다면, 어떻게 더 최적으로 정렬할 수 있을까? ==**비교를 안하면 된다.**== 이에 해당하는 정렬은 [Non-Comparison Sort (비교하지 않는 정렬)](brain/notes/CS/Algo/sort/etcsort/noncomparisonSort)이다.
