...
**fetch join**은 JPQL로 데이터를 가져올 때 처음부터 연관된 데이터까지 조인해서 가져온다. SQL의 조인을 JPQL에서 명시하는 것이라 가장 직접적인 해법이지만 [[fetch-join-limit|쓸 수 없는 자리가 있다]].
...
- [[fetch-join-limit|fetch join의 한계]]
- [[orm-jpa|ORM과 JPA]]
