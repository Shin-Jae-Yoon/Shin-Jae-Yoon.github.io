...
같은 [[aop-basics|AOP]]를 자바에서 구현한 두 갈래. 스프링 AOP는 간단한 AOP 기능을, AspectJ는 완벽한 AOP 기능을 목표로 한다.
...
[[filter-and-interceptor|Filter와 Interceptor]]에서 본 것처럼 셋 다 공통 관심사를 다루는데, AOP는 층이 더 안쪽이다.
