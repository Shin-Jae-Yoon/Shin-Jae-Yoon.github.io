...
이렇게 IP만으로 해결이 되지 않는 이유로, 아래에서 설명할 <a href='/brain/lectures/backend/kim-spring/http/section01/#tcp-udp'>TCP</a>라던가 <a href='/brain/lectures/backend/kim-spring/http/section01/#port'>PORT</a>라던가 혹은 <a href='/brain/lectures/backend/kim-spring/http/section01/#dns'>DNS</a> 등의 개념이 나오게 되었다.
...
- <a href='/brain/lectures/backend/kim-spring/http/section01/#tcp-udp'>위에서</a> 그림 보면 TCP/IP 패킷에 출발지 PORT도 있잖아~
