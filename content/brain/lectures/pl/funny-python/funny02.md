...
추가적인 내용은 [[잔재미] String](brain/lectures/pl/funny-python/funny03.md)를 참조하라.
...
format 함수를 이용한 print() 다루기는 [[잔재미] String](brain/lectures/pl/funny-python/funny03.md)에서 상세히 설명한다.
