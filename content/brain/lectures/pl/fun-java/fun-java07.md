...
- 하지만, 현재 MyData 클래스는 `hashCode()`, `equals()` 메서드를 오버라이딩 하지 않았기 때문에 부모인 Object 클래스의 것을 사용한다. <a href='/brain/lectures/pl/fun-java/fun-java04' target='_blank'>04. 객체지향 2/3</a>에서 말한 것처럼 Object의 것은 아무것도 검사해주지 않아서 쓸모가 없기 때문이다.
