...
- 캡슐화는 <a href='/brain/lectures/pl/fun-java/fun-java04/#정보-은닉'>정보 은닉</a>과도 관련있다.
...
우리가 <a href='/brain/lectures/pl/fun-java/fun-java04/#상속---부모-타입으로-자식-참조' >위에서</a> 이런 말을 했다.
