...
- [concurrency control(동시성 제어)](brain/lectures/db/easy-db/lecture15.md) 의 주된 목표가 **isolation**
...
- 영구적으로 저장한다라고 할 때는 일반적으로 ==<strong>비휘발성 메모리(HDD, SDD, ...)</strong>에 저장한다는 것을 의미==
