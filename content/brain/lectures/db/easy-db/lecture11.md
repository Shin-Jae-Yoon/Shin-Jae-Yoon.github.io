...
- [stored function](brain/lectures/db/easy-db/lecture10.md)과는 다르다.
...
그러나, 실무에서 stored procedure를 사용하는 일은 잘 없다. 이는 [다음](brain/lectures/db/easy-db/lecture12.md)에서 확인하자.