...
기본적으로 ,`<select>` 사용법은 <a href='/brain/lectures/frontend/apple-js/apple-js-01' target='_blank'>JS 입문과 웹 개발 01</a>에서 설명한 input 태그 사용법과 동일하다. input 대신 select를 사용하는 이유는, input은 자유로운 반면 **select는 선택지를 제공해줘서 데이터를 쉽게 관리**할 수 있기 때문이다.
...
실습 예제는 <a href='/brain/lectures/frontend/apple-js/apple-js-02' target='_blank'>JS 입문과 웹 개발 02</a>를 참고하도록 하자.
