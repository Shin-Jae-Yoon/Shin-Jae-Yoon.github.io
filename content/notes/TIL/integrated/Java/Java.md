...
- [Java의 실행 원리](notes/TIL/integrated/Java/JavaExecute)는 너무나 중요하다.
- 대표적인 [Java 버전](notes/TIL/integrated/Java/JavaVersion)은 Java 8, Java 11, Java 17이다.
...
1. ==**운영체제에 독립적**==
	- Java Application은 운영체제나 하드웨어가 아닌 [JVM](notes/TIL/integrated/Java/JVM)하고만 통신
...
3. ==**자동 메모리 관리(Garbage Collection)**==
	...
	- [Garbage Collector](notes/TIL/integrated/Java/GC)가 자동적으로 메모리 관리
...
5. ==**멀티스레드 지원**==
	...
	- 여러 스레드에 대한 [스케쥴링(scheduling)](notes/TIL/integrated/OS/Scheduling)을 자바 인터프리터가 담당
