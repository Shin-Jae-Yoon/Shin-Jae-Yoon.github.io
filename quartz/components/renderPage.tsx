...
export function renderPage(
  ...
  const rawContentType = componentData.fileData.frontmatter?.contentType
  ...
  const doc = (
    <html lang={lang} dir={direction}>
      <Head {...componentData} />
      <body data-slug={slug} data-basepath={basePath} data-content-type={contentType}>
  ...
  return "<!DOCTYPE html>\n" + normalizeRenderedAccessibility(render(doc))
}
