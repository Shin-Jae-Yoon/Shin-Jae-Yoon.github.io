...
<a href='/brain/notes/Interview/dog-study/dog-week03' target='_blank'>3주차 - Spring 기본 # 주입하고자 하는 의존성이 여러 개 참고</a>
...
하지만, 이 코드도 완벽하지 않다. 이는 <a href='/brain/notes/Interview/dog-study/dog-week01/' target='_blank'>개발바닥 1주차 면접스터디</a>의 DLCP 지양에 관한 이야기에서도 다룬 내용이다.
