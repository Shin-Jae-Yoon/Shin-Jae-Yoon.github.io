...
- 배열과는 다르게 삽입과 삭제가 자주 일어나는 상황에 용이
	...
	- 삭제 : ==**$O(1)$**==
	- 탐색 : ==**$O(N)$**==
- <a href='/brain/notes/CodeTree/dataStructure/#single-linked-list'>단일 연결리스트 (Single Linked List)</a>
- <a href='/brain/notes/CodeTree/dataStructure/#double-linked-list'>이중 연결리스트 (Double Linked List)</a>
