...
==**SQL에서 NULL의 의미**== : SQL [조회](brain/lectures/db/easy-db/lecture05.md)에서는 다양한 의미를 하나의 NULL로 표시
...
- 어느 한쪽에 NULL이 있다면 결과는 무조건 UNKNOWN
	- 이건 <a href=/brain/lectures/easycode/db/lecture07/#unknown-연산결과>아래</a>에서 확인
