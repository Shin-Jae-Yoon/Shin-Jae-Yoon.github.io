...
> <a href='/brain/lectures/kim-spring/http/section04/#http-api-제작'>위에서</a>는, URI는 리소스만 식별하여 명사를 사용하라고 했는데, POST의 예시로 만든 URI는 동사의 형태가 있다. 이는, 실무에서는 이상적으로 리소스인 명사만 구별할 수 없는 상황도 있기 때문이다. <br><br>
