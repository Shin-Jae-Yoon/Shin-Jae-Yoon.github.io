function custom_init() {
    if(document.getElementById('asideTOC')) {
        ...
        this.asideTOC.forEach(link => link.classList.add('text-transition'));
...
function custom_onScroll() {
    if(!this.ticking) {
        requestAnimationFrame(this.custom_update.bind(this));
        this.ticking = true;
      }
}
...
function custom_update() {
    ...
    if(active !== this.activeHeader) {
      ...
      this.asideTOC.forEach(link => link.classList.remove('text-active'));
